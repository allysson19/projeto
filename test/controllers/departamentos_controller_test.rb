...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference("Departamento.count") do
      post departamentos_url, params: { departamento: { codigodep: @departamento.codigodep, descricao: @departamento.descricao, localizacao: @departamento.localizacao, nomedepartamento: @departamento.nomedepartamento, statusdep: @departamento.statusdep, string: @departamento.string } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { codigodep: @departamento.codigodep, descricao: @departamento.descricao, localizacao: @departamento.localizacao, nomedepartamento: @departamento.nomedepartamento, statusdep: @departamento.statusdep, string: @departamento.string } }
